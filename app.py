...
def login_page():
    ...
    with col2:
        # LOGO E NOME
        # st.image("logo.png", width=120) # Se tiver logo local
        st.markdown("<h1 style='text-align: center; margin-bottom:0px;'>AInsight</h1>", unsafe_allow_html=True)
        st.markdown("<p style='text-align: center; opacity: 0.7;'>Intelligence for Business</p>", unsafe_allow_html=True)
        st.write("") 
...
def main_app():
    ...
    with st.sidebar:
        ...
        with c_logo:
            st.markdown("👁️", unsafe_allow_html=True) # Placeholder para imagem
        with c_text:
